...
import { DocumentsInput } from '@/components/prompter/documents-input'
import { PreviewAllAttachments } from '@/components/prompter/preview-all-attachments'
import { PreviewAllDocuments } from '@/components/prompter/preview-all-documents'
import { PromptInput } from '@/components/prompter/prompt-input'
import { SuggestedActions } from '@/components/suggestions/suggested-actions'
